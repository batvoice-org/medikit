# Generated by Medikit 0.8.0-15-g65777742 on 2021-04-06.
...
MEDIKIT_VERSION ?= 0.8.0-15-g65777742

.PHONY: $(SPHINX_SOURCEDIR) clean format help install install-dev quick release test update update-requirements watch-$(SPHINX_SOURCEDIR)
